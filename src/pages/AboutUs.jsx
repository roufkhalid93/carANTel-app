                    ...
                    <Col md={7}>
                        ...
                        <Card className="p-3 mb-3">
                            <Card.Body style={{ backgroundColor: '#F2D2BD' }}>
                                ...
                                <strong >car<strong style={{ color: '#880808' }}>ANT</strong>el</strong> is a leading Southeast Asian car rental and trading platform specializing in classic and vintage cars. Founded in 2024, the start-up has rapidly grown to become one of the largest and most trusted online car platforms in the region.
