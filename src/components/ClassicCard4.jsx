        ...
        <Container>
            <Card style={{ width: '18rem' }}>
                ...
                <Card.Body style={{ backgroundColor: '#E5AA70', height: '210px' }}>
                    ...
                    <Card.Title className='mb-1'>Ford Mustang GT350R</Card.Title>
                    ...
                    <Card.Text className='mb-1'><i className="bi bi-speedometer" style={{ color: '#880808' }}></i> 4.7 litre engine </Card.Text>
