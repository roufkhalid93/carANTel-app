        ...
        <Container>
            <Card style={{ width: '18rem' }}>
                ...
                <Card.Body style={{ backgroundColor: '#F8DE7E', height: '210px' }}>
                    ...
                    <Card.Title className='mb-1'>Bugatti Atalante</Card.Title>
                    ...
                    <Card.Text className='mb-1'><i className="bi bi-speedometer" style={{ color: '#880808' }}></i> 3.3 litre engine </Card.Text>
